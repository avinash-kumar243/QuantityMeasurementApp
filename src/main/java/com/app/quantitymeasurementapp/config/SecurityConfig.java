...
//		session should be stateless
	...
	public CorsConfigurationSource corsConfigurationSource() {	
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:8080", "http://127.0.0.1:5500","http://localhost:4200", "https://quantitymeasurementapp-production-6c3d.up.railway.app", "https://quantity-measurement-app-frontend-liard.vercel.app"));
